...
- When `ts1_temperature` is configured in YAML, this component now also programs `Settings:Configuration:TS1 Config` (`0x92FD`) at boot into report-only thermistor mode, with `pullup: 18k` or `pullup: 180k`.
