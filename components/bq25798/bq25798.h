...
class BQ25798Component : public PollingComponent, public i2c::I2CDevice {
 public:
  ...
  void set_ibus_current_sensor(sensor::Sensor* sensor) {
    ibus_current_sensor_ = sensor;
  }
  void set_ibat_current_sensor(sensor::Sensor* sensor) {
    ibat_current_sensor_ = sensor;
  }
  void set_vbus_voltage_sensor(sensor::Sensor* sensor) {
    vbus_voltage_sensor_ = sensor;
  }
  void set_vbat_voltage_sensor(sensor::Sensor* sensor) {
    vbat_voltage_sensor_ = sensor;
  }
  void set_vsys_voltage_sensor(sensor::Sensor* sensor) {
    vsys_voltage_sensor_ = sensor;
  }
  ...
  void set_vbus_status_text_sensor(text_sensor::TextSensor* sensor) {
    vbus_status_text_sensor_ = sensor;
  }
  ...
  void set_vbus_present_binary_sensor(binary_sensor::BinarySensor* sensor) {
    vbus_present_binary_sensor_ = sensor;
  }
  void set_vbat_present_binary_sensor(binary_sensor::BinarySensor* sensor) {
    vbat_present_binary_sensor_ = sensor;
  }
  void set_watchdog_expired_binary_sensor(binary_sensor::BinarySensor* sensor) {
    watchdog_expired_binary_sensor_ = sensor;
  }
  void set_iindpm_active_binary_sensor(binary_sensor::BinarySensor* sensor) {
    iindpm_active_binary_sensor_ = sensor;
  }
  void set_vindpm_active_binary_sensor(binary_sensor::BinarySensor* sensor) {
    vindpm_active_binary_sensor_ = sensor;
  }
  void set_thermal_regulation_binary_sensor(binary_sensor::BinarySensor* sensor) {
    thermal_regulation_binary_sensor_ = sensor;
  }
  void set_vsys_regulation_binary_sensor(binary_sensor::BinarySensor* sensor) {
    vsys_regulation_binary_sensor_ = sensor;
  }
  void set_ts_cold_binary_sensor(binary_sensor::BinarySensor* sensor) {
    ts_cold_binary_sensor_ = sensor;
  }
  void set_ts_cool_binary_sensor(binary_sensor::BinarySensor* sensor) {
    ts_cool_binary_sensor_ = sensor;
  }
  void set_ts_warm_binary_sensor(binary_sensor::BinarySensor* sensor) {
    ts_warm_binary_sensor_ = sensor;
  }
  void set_ts_hot_binary_sensor(binary_sensor::BinarySensor* sensor) {
    ts_hot_binary_sensor_ = sensor;
  }
  ...
  void set_otg_mode_switch(switch_::Switch* sw) {
    otg_mode_switch_ = sw;
  }
