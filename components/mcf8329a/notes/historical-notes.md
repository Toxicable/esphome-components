...
- Runtime behavior:
  ...
  - Superseded build compatibility note: the earlier `MCF8329A_EMBED_IMPL` workaround included `mcf8329a_client.cpp` and `mcf8329a_tuning.cpp` from `mcf8329a.cpp`. This was removed; ESPHome now compiles the sibling `.cpp` files directly.
