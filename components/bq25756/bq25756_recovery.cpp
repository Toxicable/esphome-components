...
namespace {
static const char *const TAG = "bq25756.recovery";
}

::bq25756_core::Bq25756Configuration BQ25756ComponentImpl::build_configuration_() const {
...
bool BQ25756ComponentImpl::restore_manifest_configuration_() {
...
bool BQ25756ComponentImpl::audit_manifest_configuration_() {
  const auto image = ::bq25756_core::make_configuration_image(this->build_configuration_());
...
void BQ25756ComponentImpl::mark_communication_lost_() {
...
bool BQ25756ComponentImpl::read_registers(uint8_t reg, uint8_t *data, size_t len) {
...
bool BQ25756ComponentImpl::write_registers(uint8_t reg, const uint8_t *data, size_t len) {
